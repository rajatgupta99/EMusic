...
<style>body{margin-left:0;margin-right:10px;font-family:'Raleway',sans-serif}</style>
</head>
<body>
<div class=main>
<div class=header>
...
<tr>
<td width=335><input name=search type=search id=search size=25> <input type=submit name=search id=search value=Search></td>
</tr>
</table>
</form>
</div>
